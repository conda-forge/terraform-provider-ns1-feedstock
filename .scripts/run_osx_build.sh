...
validate_recipe_outputs "terraform-provider-ns1-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-ns1-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi